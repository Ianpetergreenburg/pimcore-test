...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/login/2fa-verify'), array(0 => 'IS_AUTHENTICATED_2FA_IN_PROGRESS'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/login/2fa'), array(0 => 'IS_AUTHENTICATED_2FA_IN_PROGRESS'), NULL);
